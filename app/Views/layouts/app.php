			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							<div class="dropdown">
								<a class="nav-link dropdown-toggle" href="javascript:;" role="button" data-bs-toggle="dropdown" aria-expanded="false">Konversi</a>
								<ul class="dropdown-menu border-0 shadow-lg rounded-3">
									<?php foreach($contents->categories as $cat): ?>
										<li><a class="dropdown-item<?= $cat == $meta->name ? ' text-primary fw-bold' : '' ?>" href="<?= base_url(str_replace(' ', '-', $cat) . '-converter') ?>"><?= ucwords($cat) ?></a></li>
									<?php endforeach; ?>
								</ul>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('pricing') ?>">Berlangganan</a>
						</li>
					</ul>
  		...
  		<div class="container pt-5 mt-5">
			<div class="row mt-5">
				<div class="col-md-6 col-lg-8">
					...
					<p class="text-muted mt-3" style="max-width: 576px">
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
					</p>
				</div>
				<div class="col-md-3 col-lg-2">
					<h4 class="h6 fw-bold">Informasi</h4>
					<ul class="list-unstyled">
						<li><a class="text-dark text-decoration-none" href="<?= base_url('about') ?>"><i class="bi bi-chevron-right me-2"></i>Tentang</a></li>
						<li><a class="text-dark text-decoration-none" href="<?= base_url('format') ?>"><i class="bi bi-chevron-right me-2"></i>Format</a></li>
						<li><a class="text-dark text-decoration-none" href="<?= base_url('help') ?>"><i class="bi bi-chevron-right me-2"></i>Bantuan</a></li>
					</ul>
				</div>
				<div class="col-md-3 col-lg-2">
					<h4 class="h6 fw-bold">Konversi</h4>
					<ul class="list-unstyled">
						<?php foreach($contents->categories as $cat): ?>
							<li><a class="text-dark text-decoration-none" href="<?= base_url($cat . '-converter') ?>"><i class="bi bi-chevron-right me-2"></i><?= ucwords($cat) ?></a></li>
						<?php endforeach; ?>
					</ul>
				</div>
				<div class="col-12">
					<div class="p-3 border-top">
						<p class="text-muted text-center small">© 2024 Convy Converter ltd. Seluruh hak cipta.</p>
					</div>
				</div>
			</div>
		</div>
